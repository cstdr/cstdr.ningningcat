...
public class UIUtil {
    ...
    public static void changeBrightMode(Context context, Activity activity) {
        int brightModeNow=SPUtil.getInstance(context).getInt(context.getString(R.string.spkey_bright_mode_now), BRIGHT_MODE_UNDOWN);
        int brightModeLast=
            SPUtil.getInstance(context).getInt(context.getString(R.string.spkey_bright_mode_last), BRIGHT_MODE_UNDOWN);
